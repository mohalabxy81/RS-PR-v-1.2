...
let DealsController = class DealsController {
    ...
    async create(user, data) {
        return this.dealsService.create(user.tenantId, data);
    }
    ...
    async update(user, id, data) {
        return this.dealsService.update(user.tenantId, id, data);
    }
    async updateStage(user, id, stage) {
        return this.dealsService.updateStage(user.tenantId, id, user.userId, stage);
    }
    async addNote(user, id, content) {
        return this.dealsService.addNote(user.tenantId, id, user.userId, content);
    }
};
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all deals (useful for Kanban)' }),
